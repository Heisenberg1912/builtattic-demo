...
const quickAccessTiles = [
  ...
  },
  {
    ...
    description: "Manage Builtattic Prime-style perks and credits.",
    icon: Crown,
    to: "/account",
  },
];
          ...
          <div className="flex flex-wrap items-end justify-between gap-4">
            <div>
              ...
              <p className="text-sm text-slate-600 max-w-2xl">
                Manage orders, subscriptions, and professional services the way you would on Amazon—
                but tailored for architecture and design collaborations.
              </p>
            </div>
            <Link
              to="/settings"
        ...
        <section>
          <div className="flex flex-wrap items-center justify-between gap-3 mb-4">
            ...
            <span className="text-xs uppercase tracking-[0.25em] text-slate-400">
              Inspired by Amazon account hub
            </span>
          </div>
