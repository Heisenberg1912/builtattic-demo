...
const privacyControls = [
  ...
  },
  {
    ...
    description: "Extend history to match Amazon-style archive timelines.",
  },
];
      ...
      <main className="max-w-5xl mx-auto px-4 py-10 space-y-8">
          ...
          <div className="flex flex-wrap items-end justify-between gap-4">
            <div>
              ...
              <p className="text-sm text-slate-600 max-w-2xl">
                Tailor your Builtattic experience with Amazon-inspired security, notification, and
          ...
          <div className="flex items-center justify-between gap-3">
            <div>
              ...
              <p className="text-sm text-slate-600">
                Borrowed from Amazon’s login hub to keep your catalogue access protected.
              </p>
            </div>
          </div>
        ...
        <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm space-y-5">
          <div>
            ...
            <p className="text-sm text-slate-600">
              Mirror Amazon’s granular channel management for Builtattic alerts.
            </p>
          </div>
        ...
        <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm space-y-5">
          <div>
            ...
            <p className="text-sm text-slate-600">
              Amazon-style transparency for what gets shared with studios, vendors, and clients.
            </p>
          </div>
          <div className="space-y-3">
