...
const Navbar = () => {
  ...
  // Add: global currency context event
  useEffect(() => {
  ...
  const handleCurrencyChange = (code) => {
    ...
    window.dispatchEvent(
      new CustomEvent("currency:change", { detail: { code } })
    );
  };
  ...
  const wishlistCtx =
    (typeof useWishlist === "function" ? useWishlist() : null) || {};
  const cartItems = Array.isArray(cartCtx.cartItems) ? cartCtx.cartItems : [];
  const wishlistItems = Array.isArray(wishlistCtx.wishlistItems)
    ? wishlistCtx.wishlistItems
    : [];
  ...
  // Dropdown state for currency/wishlist/cart
    ...
    <>
      <nav className="bg-black/95 sticky top-0 z-50 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 flex items-center justify-between h-14">
          ...
          <NavLink
            to="/"
            className="flex items-center text-xl font-bold text-gray-100"
          >
            <img
              src={main_logo}
              alt="Builtattic Logo"
          ...
          <div className="hidden md:flex space-x-8 items-center">
            <NavLink to="/ai" className="text-gray-100 hover:text-gray-100 text-xs">
              AI
            </NavLink>
            <NavLink to="/studio" className="text-gray-100 hover:text-gray-100 text-xs">
              Studio
            </NavLink>
            <NavLink to="/firms" className="text-gray-100 hover:text-gray-100 text-xs">
              Firms
            </NavLink>
            <NavLink
              to="/associates"
              className="text-gray-100 hover:text-gray-100 text-xs"
            >
              Associates
            </NavLink>
            <NavLink
            ...
            {/* Dropdown for Currency, Wishlist, Cart (triggered by avatar) */}
                ...
                {isDropdownOpen && (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2">
                      <HiOutlineGlobeAlt className="text-xl text-gray-100" />
                      <select
            ...
            {isAuthed ? (
              ...
              <NavLink
                to="/login"
                className="text-gray-100 hover:text-gray-300 text-xs"
              >
                Login
              </NavLink>
            )}
        ...
        {isMenuOpen && (
          <div className="md:hidden px-4 pb-4 flex flex-col space-y-3">
            ...
            {/* Dropdown for Currency, Wishlist, Cart */}
            <div className="relative">
              <button
